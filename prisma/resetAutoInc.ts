...
export const resetAutoInc = async () => {
  ...
  await prisma.$queryRaw`ALTER SEQUENCE workshop_change_requests_workshop_change_request_id_seq RESTART WITH 1;`
  ...
  await prisma.$queryRaw`ALTER SEQUENCE workshop_sessions_change_requests_workshop_session_change_request_id_seq RESTART WITH 1;`
