...
export const resetAutoInc = async () => {
  ...
  await prisma.$queryRaw`ALTER SEQUENCE unavailable_days_unavailable_id_seq RESTART WITH 1;`
  ...
  await prisma.$queryRaw`ALTER SEQUENCE requested_start_times_request_id_seq RESTART WITH 1;`
  await prisma.$queryRaw`ALTER SEQUENCE change_log_log_id_seq RESTART WITH 1;`
  ...
  await prisma.$queryRaw`ALTER SEQUENCE session_notes_note_id_seq RESTART WITH 1;`
  await prisma.$queryRaw`ALTER SEQUENCE licenses_license_id_seq RESTART WITH 1;`
