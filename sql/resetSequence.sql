...
ALTER SEQUENCE requested_start_times_request_id_seq RESTART WITH 1;
ALTER SEQUENCE change_log_log_id_seq RESTART WITH 1;
...
ALTER SEQUENCE session_notes_note_id_seq RESTART WITH 1;
